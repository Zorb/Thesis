...
<body>
  ...
  <section>
    ...
    <div class="mainmenu pull-right">
      <ul class="nav navbar-nav collapse navbar-collapse">
        <li><a href="Account.php" >Listings</a></li>
        <li ><a href="#"class="active">Requests</a>
  ...
  <div class="col-sm-12 ">
      <div class="item active">
        ...
        $id = $_SESSION['id'];
            ...
            $sql = "SELECT * FROM products WHERE owner = '$id' AND now != 0";
            $result = mysqli_query($conn, $sql);
            while($row = mysqli_fetch_assoc($result)){
              $now=$row['now'];
              $sql2 = "SELECT * FROM members WHERE id = '$now' ";
                    ...
                    echo"	<div class='single-products'>";
                        echo"<div class='productinfo text-center'>";
                           echo "<img src='uploads/$img1'  />
                                      <h2>$price €</h2>
                                      <h3>$pname</h3>";
                      echo"Sent to Mr/Mrs $lname <br> Location: $city  $addr  $area<br>";
