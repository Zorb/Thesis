					...
					<!--	<div class="brands_products"><!brands_products>
						...
						<div class="price-range"><!--price-range-->
							...
							<div class="well text-center">
								 <input type="text" class="span2" name="prange" data-slider-min="0" data-slider-max="1000" data-slider-step="5" data-slider-value="[0,600]" id="sl2" ><br />
