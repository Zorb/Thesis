...
<div class="recommended_items"><!--recommended_items-->
  <h2 class="title text-center">Items in Your Cart</h2>
  ...
  <div class="col-sm-12 ">
      <div class="item active">
        ...
        $id = $_SESSION['id'];
            ...
            $sql = "SELECT * FROM products WHERE now = '$id'";
            ...
            while($row = mysqli_fetch_assoc($result)){
              ...
              $pid=$row['id'];
                ...
                echo"		<div class='product-image-wrapper'>";
                    ...
                    echo"<button type='submit' name='remove' class='btn btn-default add-to-cart'>Return Product</button>
